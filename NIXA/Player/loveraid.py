...
LOVEOP = [
   ...
   "WHY YOUR EYES ARE SO BUTIFULL 🥵",
    ...
    "I AM YOUR KING AND YIU ARE MY QUEEN LETS MAKE A UNIQUE STORY ❤️",
    "IF THIS IS NOT LOVE THEN WHAT IS 🥺❤️",
    "AAJ TAK ME KISIKE SAMNE NAI JHUKA BUT APNE PYAAR KE SAMNE ME HAAR GAYA🥺",
    "WHY I WANT YOU SO MUCH ❤️🥺",
    "LOVE IS PART OF HEART AND YIU ARE MINE 🙈",
